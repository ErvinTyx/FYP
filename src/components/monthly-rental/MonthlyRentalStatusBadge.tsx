...
import { MonthlyRentalInvoiceStatus } from "../../types/monthly-rental";

interface MonthlyRentalStatusBadgeProps {
  status: MonthlyRentalInvoiceStatus;
}

export function MonthlyRentalStatusBadge({ status }: MonthlyRentalStatusBadgeProps) {
  switch (status) {
