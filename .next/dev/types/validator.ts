...
// Validate ../../../app/api/user-management/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/user-management">> = Specific
  const handler = {} as typeof import("../../../app/api/user-management/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
